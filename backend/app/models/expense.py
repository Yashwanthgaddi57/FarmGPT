"""Expense tracking model — farm economics ground truth (Part 19)."""
import uuid
...
# Fixed category set (validated at the schema layer)
EXPENSE_CATEGORIES = (
...
class Expense(Base):
    ...
    category: Mapped[str] = mapped_column(Text, nullable=False)  # one of EXPENSE_CATEGORIES
